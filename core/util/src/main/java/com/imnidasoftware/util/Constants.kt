package com.imnidasoftware.util

object Constants {

    const val APP_ID = "mydaydiary-rsfmc"
    const val CLIENT_ID = "561867093073-ilspq10pqkqkvjehr9a8ktk88fng89bj.apps.googleusercontent.com"
